...
function useOptionalIConfirm() {
  const dialog = React8.useContext(IDialogContext);
  const show = React8.useCallback(
    async (data) => {
...
var IAuthContext = React8.createContext(null);
function useIAuthContext() {
  const ctx = React8.useContext(IAuthContext);
  if (!ctx) {
    throw new Error(
...
var IHMenu = React8.memo(function IHMenu2(props) {
  ...
  const favoriteSubtitle = React8.useMemo(() => {
    var _a;
...
function FavoritesSection({
  ...
  const pathByKey = React8.useMemo(
...
function IHSidebar(props) {
  ...
  const navigate = reactRouterDom.useNavigate();
  const auth = React8.useContext(IAuthContext);
  const headerRef = React8.useRef(null);
  const [accountMenuOpen, setAccountMenuOpen] = React8.useState(false);
  ...
  const onLogoutClick = React8.useCallback(() => {
    var _a, _b;
    setAccountMenuOpen(false);
    if (!auth) return;
...
var IRouteAccessContext = React8.createContext(null);
...
function IRouter(props) {
  ...
  const hostApi = useHostApiOptional();
  const location = reactRouterDom.useLocation();
  const [deniedOwners, setDeniedOwners] = React8.useState(() => /* @__PURE__ */ new Set());
  const reportAccess = React8.useCallback((owner, denied2) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(IRouteAccessContext.Provider, { value: reportAccess, children: /* @__PURE__ */ jsxRuntime.jsx(React8.Suspense, { fallback: loading, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Routes, { children: [
    routeElements,
...
function IAuthProvider({
  ...
  const resolved = React8.useMemo(() => resolveIAuthConfig(config), [config]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(IAuthContext.Provider, { value: services.value, children });
}
...
function ISessionExpiredDialog() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex align-center justify-center", style: overlayStyle, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "bg-white radius-md p-3xl text-center", style: cardStyle, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-warning mb-lg", children: /* @__PURE__ */ jsxRuntime.jsx(IIcon, { icon: iconClass, size: "4xl" }) }),
    /* @__PURE__ */ jsxRuntime.jsx("h1", { className: "m-0 mb-xs text-2xl font-semibold text-gray-800", children: TITLES[reason ?? "default"] }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "m-0 mb-2xl text-md leading-normal text-subtle", children: message }),
    /* @__PURE__ */ jsxRuntime.jsx(IButton, { type: "button", onClick: onConfirm, children: "Log in again" })
  ] }) });
}
...
function IRequireAccess({
  ...
  const [menusLoading, setMenusLoading] = React8.useState(
...
function IHasMnRoute({ value, children }) {
  ...
  const store = useIUserMenuStore();
  const allowed = usePermission(value);
  const reportAccess = React8.useContext(IRouteAccessContext);
  const owner = React8.useId();
  ...
  if (!allowed) {
    return /* @__PURE__ */ jsxRuntime.jsxs(ISection, { role: "alert", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ISectionHeader, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(IIcon, { icon: "fa-solid fa-user-lock" }),
        " Unauthorized Access"
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx(ISectionBody, { children: /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-subtle", children: "You do not have access to this page. Please contact your administrator." }) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children });
}
function hasMn(value, content) {
  if (typeof content === "function") {
    const Page = React8.lazy(async () => ({ default: await content() }));
    const GuardedPage = () => /* @__PURE__ */ jsxRuntime.jsx(IHasMnRoute, { value, children: /* @__PURE__ */ jsxRuntime.jsx(React8.Suspense, { fallback: /* @__PURE__ */ jsxRuntime.jsx(ILoading, { label: "Loading page...", "aria-live": "polite" }), children: /* @__PURE__ */ jsxRuntime.jsx(Page, {}) }) });
    return async () => GuardedPage;
  }
  return React8.createElement(IHasMnRoute, { value, children: content });
}
