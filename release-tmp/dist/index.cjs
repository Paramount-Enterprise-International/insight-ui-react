...
function makeElement(r) {
  ...
  if (r.loadComponent) {
    const C = React8.lazy(r.loadComponent);
...
function IRouter(props) {
  ...
  const routeElements = React8.useMemo(() => renderRouteTree(routes), [routes]);
  return /* @__PURE__ */ jsxRuntime.jsxs(React8.Suspense, { fallback: loading, children: [
    /* @__PURE__ */ jsxRuntime.jsx(IRouterMetaSync, {}),
    /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Routes, { children: [
      redirectIndexTo ? /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { index: true, element: /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Navigate, { to: redirectIndexTo, replace: true }) }) : null,
      routeElements,
