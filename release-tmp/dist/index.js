...
import React8, { useRef, useMemo, forwardRef, useState, useEffect, useCallback, useImperativeHandle, useLayoutEffect, createContext, memo, Children, useContext, useSyncExternalStore, Suspense, lazy } from 'react';
...
function IRouter(props) {
  ...
  return /* @__PURE__ */ jsx(Suspense, { fallback: loading, children: /* @__PURE__ */ jsxs(Routes, { children: [
    routeElements,
...
function ISessionExpiredDialog() {
  ...
  return /* @__PURE__ */ jsx("div", { style: overlayStyle, children: /* @__PURE__ */ jsxs("div", { style: cardStyle, children: [
    /* @__PURE__ */ jsx("div", { style: iconStyle, children: /* @__PURE__ */ jsx("i", { className: iconClass }) }),
    /* @__PURE__ */ jsx("h1", { style: titleStyle, children: TITLES[reason ?? "default"] }),
    /* @__PURE__ */ jsx("p", { style: messageStyle, children: message }),
    /* @__PURE__ */ jsx("button", { type: "button", style: actionStyle, onClick: onConfirm, children: "Log in again" })
  ] }) });
}
