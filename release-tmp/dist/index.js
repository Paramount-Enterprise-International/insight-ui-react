...
var ISessionService = class {
  ...
  tryRestoreSession() {
    ...
    const timer = setTimeout(
      () => controller == null ? void 0 : controller.abort(requestCancellation("timeout")),
      1e4
    );
    this.restoreInFlight = refresh.then(() => ({})).catch((err) => {
      ...
      if (isSessionExpiredError(err))
        void this.authService.logout().catch(() => void 0);
      return { reason };
    }).finally(() => {
      clearTimeout(timer);
      if (!this.disposed) {
      ...
      children: /* @__PURE__ */ jsx(
        IDialog,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col align-center text-center gap-lg", children: [
            /* @__PURE__ */ jsx(IIcon, { className: "text-warning", icon: iconClass, size: "3xl" }),
