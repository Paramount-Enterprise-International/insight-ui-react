...
import React8, { useRef, useState, useMemo, forwardRef, useEffect, useImperativeHandle, createContext, memo, useLayoutEffect, useCallback, useContext, Children } from 'react';
...
function IHContent(props) {
  ...
  return /* @__PURE__ */ jsxs("ih-content", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "ih-content-breadcrumbs", children: crumbs.length > 0 ? crumbs.map((b, idx) => {
      const first = idx === 0;
      const last = idx === crumbs.length - 1;
      if (!last) {
        return /* @__PURE__ */ jsxs(React8.Fragment, { children: [
          !first ? b.url ? /* @__PURE__ */ jsx(
            "a",
            {
          ...
          ) : /* @__PURE__ */ jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__link", children: b.label }) : /* @__PURE__ */ jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__first", children: b.label }),
          /* @__PURE__ */ jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__separator", children: ">" })
        ] }, `${b.label}-${idx}`);
      }
      return /* @__PURE__ */ jsx(
        "span",
...
function resolveTitle(title, ctx) {
  return typeof title === "function" ? title(ctx) : title;
}
function resolveBreadcrumbs(crumbs, ctx) {
...
export { DEFAULT_ERROR_FACTORIES, IAlert, IButton, ICard, ICardBody, ICardFooter, ICardImage, ICodeViewer, IConfirm, IDatepicker, IDialog, IDialogClose, IDialogOutlet, IDialogProvider, IDialogRef, IFCDatepicker, IFCInput, IFCSelect, IFCTextarea, IGrid, IGridColumn, IGridColumnGroup, IGridCustomColumn, IGridDataSource, IGridExpandableRow, IHContent, IHMenu, IHSidebar, IHostApiProvider, IIcon, IInput, IInputAddon, ILoading, IPaginator, IRPage, ISection, ISectionBody, ISectionFilter, ISectionFooter, ISectionHeader, ISectionSubHeader, ISectionTab, ISectionTabContent, ISectionTabHeader, ISectionTabs, ISelect, ITextarea, I_ICON_NAMES, I_ICON_SIZES, asMinMaxLengthError, hasNumber, interpolate, isControlRequired, isRecord, readNumber, resolveControlErrorMessage, useDialogData, useDialogRef, useHostApi, useIAlertService, useIConfirmService, useIDialog, useInputMask };
