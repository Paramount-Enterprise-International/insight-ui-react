...
function IIcon(props) {
  ...
  return /* @__PURE__ */ jsx("i-icon", { className, ...rest, children: /* @__PURE__ */ jsx("i", { className: iconClass }) });
}
    ...
    "i-options",
    {
      ...
      children: filteredOptions.map((row, idx) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "i-option-label", children: renderOption ? renderOption(row) : highlightParts(resolveDisplayText(row), effectiveFilterText) }),
