...
function IIcon(props) {
  ...
  return /* @__PURE__ */ jsx("i-icon", { className, icon: String(icon), size, ...rest, children: /* @__PURE__ */ jsx("i", { className: iconClass }) });
}
...
function ICard(props) {
  ...
  return /* @__PURE__ */ jsx("i-card", { className, ...rest, children: useRouterLink ? /* @__PURE__ */ jsx(
    Link,
    {
      className: "i-card",
...
function IGrid(props) {
  ...
  const HeaderCell = (p) => {
    ...
    return /* @__PURE__ */ jsxs(
      "i-grid-header-cell",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "i-grid-header-cell__content", truncatedtooltip: true, children: children2 }),
  ...
  return /* @__PURE__ */ jsxs("i-grid", { className: "i-grid", role: "table", children: [
    /* @__PURE__ */ jsxs("i-grid-viewport", { className: "i-grid-viewport", children: [
      effectiveHeaderItems.length ? /* @__PURE__ */ jsxs("i-grid-header-row", { className: "i-grid-header-row", children: [
      ...
      renderedData.map((row, rowIndex) => {
        ...
        return /* @__PURE__ */ jsxs(React8.Fragment, { children: [
                      ...
                      Cell,
                      {
                        ...
                        children: /* @__PURE__ */ jsxs("span", { className: "i-grid-tree-inline", children: [
                          ...
                          col.cellDef ? renderCellDef(col.cellDef, row, {
                            ...
                            index: rowIndex,
                            column: col
                          }) : /* @__PURE__ */ jsx("span", { className: "i-grid-tree-text", truncatedtooltip: true, children: col.fieldName ? highlightSearchFn(
                            String(
                  ...
                  return /* @__PURE__ */ jsx(
                    Cell,
                    {
                      ...
                      children: col.cellDef ? renderCellDef(col.cellDef, row, {
                        ...
                        index: rowIndex,
                        column: col
                      }) : /* @__PURE__ */ jsx("span", { className: "i-grid-cell__content", truncatedtooltip: true, children: col.fieldName ? highlightSearchFn(
                        String(
                          (row == null ? void 0 : row[col.fieldName]) ?? ""
                        ),
                        currentFilterText
          ...
          hasExpandableRow && isRowExpanded(row) ? /* @__PURE__ */ jsx("i-grid-expandable-row", { className: "i-grid-expandable-row flex", children: expandableRowDef.render(row, { row, index: rowIndex }) }) : null
        ] }, `r-${key}`);
      })
    ] }),
...
function ISectionHeader(props) {
  ...
  return /* @__PURE__ */ jsx("i-section-header", { ...rest, children: /* @__PURE__ */ jsx("h4", { children }) });
}
function ISectionSubHeader(props) {
  const { children, ...rest } = props;
  return /* @__PURE__ */ jsx("i-section-sub-header", { ...rest, children: /* @__PURE__ */ jsx("h6", { children }) });
}
