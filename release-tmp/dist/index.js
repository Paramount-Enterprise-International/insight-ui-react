...
import React8, { useRef, useMemo, forwardRef, useState, useImperativeHandle, useEffect, useLayoutEffect, createContext, memo, useCallback, useContext, Children, Suspense, useId, lazy } from 'react';
...
function IIcon(props) {
  ...
  return /* @__PURE__ */ jsx("i-icon", { className, ...rest, children: /* @__PURE__ */ jsx("i", { className: innerClass }) });
}
...
function getBasePathname() {
  ...
  const p = ((_a = window.location) == null ? void 0 : _a.pathname) ?? "/";
...
function withQueryAndFragment(href, queryParams, fragment) {
  if (!href) return href;
...
function ICard(props) {
  ...
  const rawEffectiveHref = disabled ? void 0 : routerHref ?? normalizedHref;
  ...
  return /* @__PURE__ */ jsx("i-card", { className, ...rest, children: /* @__PURE__ */ jsx(
    "a",
    {
      className: "i-card",
      "aria-disabled": disabled ? "true" : void 0,
...
function ICodeViewer(props) {
  ...
  return /* @__PURE__ */ jsxs("i-code-viewer", { ...rest, children: [
    needsProjectionHost ? /* @__PURE__ */ jsx("div", { ref: projectedRef, "aria-hidden": "true", style: { display: "none" }, children }) : null,
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: [
...
function useInputMask(inputRef, mask, opts = {}) {
  ...
  useEffect(() => {
    ...
    const setValue = (v, o) => {
      ...
      if ((o == null ? void 0 : o.emit) !== false) dispatchInput();
    };
    ...
    const adjustDateSegmentByArrow = (key) => {
      ...
      maxDay = daysInMonth(year || 2e3, month);
...
function IInputAddon(props) {
  ...
  ) : addon.type === "icon" ? /* @__PURE__ */ jsx(IIcon, { icon: addon.icon, size: "sm" }) : addon.type === "link" ? /* @__PURE__ */ jsxs(
    "a",
    {
      href: addon.href,
      ...
      children: [
        addon.icon ? /* @__PURE__ */ jsx(IIcon, { icon: addon.icon, size: "sm" }) : null,
        addon.text
      ]
    }
  ) : addon.type === "loading" ? /* @__PURE__ */ jsx(ILoading, {}) : /* @__PURE__ */ jsx("span", { children: addon.text }) });
}
var IInput = React8.forwardRef(
  function IInput2(props, forwardedRef) {
    ...
    const appends = useMemo(() => normalizeArray(append), [append]);
    const setRefs = (node) => {
    ...
    return /* @__PURE__ */ jsxs("i-input", { className, onClick: handleHostClick, children: [
      prepends.map((a, idx) => /* @__PURE__ */ jsx(IInputAddon, { addon: a }, `prepend-${idx}`)),
      /* @__PURE__ */ jsx(
        "input",
        {
          ...rest,
      ...
      appends.map((a, idx) => /* @__PURE__ */ jsx(IInputAddon, { addon: a }, `append-${idx}`))
    ] });
  }
);
function IFCInput(props) {
  ...
  const focusInnerInput = () => {
    var _a;
    if (!disabled) (_a = innerRef.current) == null ? void 0 : _a.focus();
  };
  return /* @__PURE__ */ jsxs("i-fc-input", { className, ...hostProps, children: [
...
function highlightParts(text, term) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    before,
    /* @__PURE__ */ jsx("mark", { children: match }),
    after
  ] });
}
var ISelect = forwardRef(function ISelectInner(props, ref) {
  ...
  const getAnchorRect = () => {
    ...
    if (iInput == null ? void 0 : iInput.getBoundingClientRect) return iInput.getBoundingClientRect();
    if (host.getBoundingClientRect)
      return host.getBoundingClientRect();
    const input = host.querySelector(
      "i-input input"
    );
    return ((_a = input == null ? void 0 : input.getBoundingClientRect) == null ? void 0 : _a.call(input)) ?? null;
  };
  const repositionPanelNow = () => {
    ...
    const top = side === "bottom" ? rect.bottom + panelOffset : rect.top - panelRect.height - panelOffset;
    panel.style.left = `${Math.round(left)}px`;
    panel.style.top = `${Math.round(top)}px`;
  };
  const scheduleReposition = (after) => {
    if (!wantsOpenRef.current) return;
  ...
  const optionsNode = hasOptionsList ? /* @__PURE__ */ jsx(
    "i-options",
    {
      ...
      className: `i-options scroll scroll-y ${panelPositionClass2}`,
      style: panelHidden ? {
        visibility: "hidden",
        pointerEvents: "none"
      } : void 0,
      children: filteredOptions.map((row, idx) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "i-option-label", children: renderOption ? renderOption(row) : /* @__PURE__ */ jsx("span", { children: highlightParts(resolveDisplayText(row), filterText) }) }),
...
var IFCSelect = forwardRef(function IFCSelectInner(props, ref) {
  ...
  return /* @__PURE__ */ jsxs("i-fc-select", { ...hostProps, className, children: [
...
function IDatepicker(props) {
  ...
  const getAnchorRect = () => {
    ...
    const iInput = host.querySelector("i-input");
    if (iInput == null ? void 0 : iInput.getBoundingClientRect) return iInput.getBoundingClientRect();
    return ((_a = host.getBoundingClientRect) == null ? void 0 : _a.call(host)) ?? null;
  };
  useEffect(() => {
  ...
  const removeGlobalListeners = useCallback(() => {
    if (!listeningGlobalRef.current) return;
    const rm = addGlobalListeners._rm;
    if (rm) rm();
    delete addGlobalListeners._rm;
  ...
  const panelNode = /* @__PURE__ */ jsxs(
    "i-datepicker-panel",
    {
      ...
      style: {
        display: isOpen ? "" : "none",
        ...panelHidden ? { visibility: "hidden", pointerEvents: "none" } : null
      },
      children: [
...
function ITextArea(props) {
  ...
  return /* @__PURE__ */ jsx("i-textarea", { onClick: handleHostClick, children: /* @__PURE__ */ jsx(
    "textarea",
    {
      ...rest,
      ref: textareaRef,
...
function ISectionTabs(props) {
  ...
  return /* @__PURE__ */ jsxs("i-section-tabs", { className, ...rest, children: [
