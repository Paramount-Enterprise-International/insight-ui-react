...
type IRTitle = string | null | ((ctx: IRPageCtx) => string | null);
type IRBreadcrumb = IBreadcrumbItem | ((ctx: IRPageCtx) => IBreadcrumbItem | null | undefined);
type IRPageProps = {
    title: IRTitle;
...
declare function IRPage(props: IRPageProps): react_jsx_runtime.JSX.Element;
