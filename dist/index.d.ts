...
import React__default, { ReactNode, JSX, HTMLAttributes, ReactElement } from 'react';
...
declare class IUserMenuStore {
    ...
    private companiesValue;
    private companyCodesValue;
    private menuCompaniesValue;
