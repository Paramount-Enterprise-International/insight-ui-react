...
function IHSidebar(props) {
  ...
  return /* @__PURE__ */ jsxs("ih-sidebar", { class: !visible ? "hidden" : void 0, children: [
    /* @__PURE__ */ jsx("div", { className: "ih-sidebar-header", ref: headerRef, children: user ? /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      accountMenuOpen ? /* @__PURE__ */ jsxs("div", { className: "ih-user-dropdown", role: "menu", children: [
        /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "Personal Profile" })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
...
var IUserMenuService = class {
  ...
  async getAuthorizations(applicationId) {
    ...
    const response = await this.api.get("/me/authorizations", {
      apiUrl: this.baseUrl,
...
function IRequireRouteAccess({
  ...
  const isAuth = session.isAuth();
  const menusSettled = store.menus.length > 0 || store.loadErrors.menus !== null;
  const canOpenPath = canOpen ?? ((path2, currentStore) => currentStore.hasRoute(path2));
  const [menusLoading, setMenusLoading] = useState(
