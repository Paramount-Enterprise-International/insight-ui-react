...
import React8, { useRef, useMemo, forwardRef, useState, useEffect, useCallback, useImperativeHandle, useLayoutEffect, createContext, memo, useContext, Children, Suspense, lazy } from 'react';
...
function isNewTabMenu(menu) {
  ...
  return !!route && !!(menu == null ? void 0 : menu.openInNewTab);
}
...
var IHMenu = memo(function IHMenu2(props) {
  ...
  const linkRel = useMemo(() => {
    ...
    return isNewTabMenu(menu) ? "noopener noreferrer" : void 0;
  }, [menu]);
  useLayoutEffect(() => {
...
function ISectionTabs(props) {
  ...
  return /* @__PURE__ */ jsxs("i-section-tabs", { class: className, ...rest, children: [
    /* @__PURE__ */ jsx("div", { className: "i-section-tabs-headers", role: "tablist", children: tabs.map((tab, index) => {
