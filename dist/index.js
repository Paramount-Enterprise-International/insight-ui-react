...
import React8, { useRef, useMemo, forwardRef, useState, useEffect, useCallback, useImperativeHandle, useLayoutEffect, createContext, memo, Children, useContext, useSyncExternalStore, Suspense, useId, lazy, createElement } from 'react';
...
function IDialogContainer(props) {
  ...
  return /* @__PURE__ */ jsxs("i-dialog-container", { children: [
    /* @__PURE__ */ jsx("div", { className: "i-dialog-backdrop", onClick: onBackdropClick }),
    /* @__PURE__ */ jsx("div", { className: "i-dialog-wrapper", children: /* @__PURE__ */ jsx("div", { className: "i-dialog-panel", style: panelStyles, children: /* @__PURE__ */ jsx(
      ...
      effectiveHeaderItems.length ? /* @__PURE__ */ jsxs("i-grid-header-row", { class: "i-grid-header-row", children: [
        ...
        effectiveHeaderItems.map((item, idx) => {
          if (item.kind === "col") {
            ...
            if (col.headerDef) {
              return /* @__PURE__ */ jsx(React8.Fragment, { children: col.headerDef(col) }, `h-${idx}`);
            }
            return /* @__PURE__ */ jsx(
              HeaderCell,
              {
                ...
                /* @__PURE__ */ jsx(
                  "i-grid-header-cell-group-columns",
                  {
                    ...
                    children: item.columns.map((col, cIdx) => {
                      if (col.headerDef) {
                        return /* @__PURE__ */ jsx(React8.Fragment, { children: col.headerDef(col) }, `gc-${cIdx}`);
                      }
                      return /* @__PURE__ */ jsx(
                        HeaderCell,
                        {
...
function IRouter(props) {
  const {
    ...
    notFound = /* @__PURE__ */ jsx("div", { style: { padding: 16 }, children: "Not Found" })
  } = props;
  const hostApi = useHostApiOptional();
  const location = useLocation();
...
function ISectionTabs(props) {
  ...
  const tabs = useMemo(() => {
    const arr = React8.Children.toArray(children);
...
function resolveApiErrorDisplayMessage(error, localFallback, catalogResolver) {
...
async function rawRequest(baseUrl, path, csrf, options = {}) {
  ...
  try {
    ...
    throw normalizeApiError({ status: 0, message: "Network error", detail: "Network error", ...err });
  }
...
var IAuthService = class {
  ...
  async login(username, password, recaptchaToken, isChallengeResponse) {
    ...
    try {
      const res = await rawRequest(this.identityUrl, getAuthEndpointPath(this.config, "login"), this.csrf, {
        method: "POST",
        body: {
          username,
          password,
  ...
  refresh() {
    return rawRequest(this.identityUrl, getAuthEndpointPath(this.config, "refresh"), this.csrf, {
      method: "POST",
      body: {}
    });
  }
  ...
  async logout(refreshToken) {
    await rawRequest(this.identityUrl, getAuthEndpointPath(this.config, "logout"), this.csrf, {
      method: "POST",
      body: { refreshToken }
    });
  }
  ...
  exchangeAuthToken(authToken) {
    return rawRequest(this.identityUrl, getAuthEndpointPath(this.config, "exchange"), this.csrf, {
      method: "POST",
      body: {},
...
var IUserMenuStore = class {
  ...
  async load(applicationId) {
    ...
    await Promise.all([
      ...
      this.loadPermissionsInternal(applicationId).catch(
        (err) => this.recordError("permissions", err)
      )
    ]);
    this.initializingValue = false;
   ...
   */
  async loadPermissions(applicationId) {
    try {
      const items = await this.menuService.getAuthorizations(applicationId);
  ...
  applyAuthorizations(items) {
    ...
    const permissionCodes = /* @__PURE__ */ new Set();
    ...
    for (const authorization of authorizations) {
      ...
      const scopedCodes = menuCompanySets.get(authorization.menuCode) ?? /* @__PURE__ */ new Set();
  ...
  async loadPermissionsInternal(applicationId) {
...
function IAuthProvider({
  ...
  return /* @__PURE__ */ jsx(IAuthContext.Provider, { value: services.value, children });
}
...
function ISessionExpiredDialog() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex align-center justify-center", style: overlayStyle, children: /* @__PURE__ */ jsxs("div", { className: "bg-white radius-md p-3xl text-center", style: cardStyle, children: [
    /* @__PURE__ */ jsx("div", { className: "text-warning mb-lg", children: /* @__PURE__ */ jsx(IIcon, { icon: iconClass, size: "4xl" }) }),
    /* @__PURE__ */ jsx("h1", { className: "m-0 mb-xs text-2xl font-semibold text-gray-800", children: TITLES[reason ?? "default"] }),
    /* @__PURE__ */ jsx("p", { className: "m-0 mb-2xl text-md leading-normal text-subtle", children: message }),
    /* @__PURE__ */ jsx(IButton, { type: "button", onClick: onConfirm, children: "Log in again" })
  ] }) });
}
...
function IRequireAccess({
  ...
  const allowed = source === "role" ? session.hasRole(value) : source === "permission" ? store.hasPermission(value) : store.hasMenu(value);
  if (!allowed) {
...
function IHasMnRoute({ value, children }) {
  ...
  if (!allowed) {
    return /* @__PURE__ */ jsxs(ISection, { role: "alert", children: [
      /* @__PURE__ */ jsxs(ISectionHeader, { children: [
        /* @__PURE__ */ jsx(IIcon, { icon: "fa-solid fa-user-lock" }),
        " Unauthorized Access"
      ] }),
      /* @__PURE__ */ jsx(ISectionBody, { children: /* @__PURE__ */ jsx("p", { className: "text-subtle", children: "You do not have access to this page. Please contact your administrator." }) })
    ] });
  }
  return /* @__PURE__ */ jsx(Fragment, { children });
}
