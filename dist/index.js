...
import { useNavigate, useMatches, Outlet, useLocation } from 'react-router-dom';
...
function highlightSearchHtml(text, rawTerm) {
  ...
  while (i < safeText.length) {
    ...
    out += `<span class="highlight-search">${escapeHtml3(safeText.slice(idx, idx + term.length))}</span>`;
    i = idx + term.length;
  }
  return out;
}
...
function buildBreadcrumbsFromMatches(matches) {
  const crumbs = [];
...
function IHContent(props) {
  ...
  const pageTitle = breadcrumbs.length ? breadcrumbs[breadcrumbs.length - 1].label : "Insight";
  const [sidebarVisibility, setSidebarVisibility] = useState(true);
  const toggleSidebar = useCallback(() => {
    setSidebarVisibility((prev) => {
      const next = !prev;
      onSidebarToggled == null ? void 0 : onSidebarToggled(next);
      return next;
    });
  }, [onSidebarToggled]);
  return /* @__PURE__ */ jsxs("ih-content", { children: [
    /* @__PURE__ */ jsxs("div", { className: "ih-content-header", children: [
      ...
      /* @__PURE__ */ jsx("h1", { children: pageTitle || "Insight" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "ih-content-breadcrumbs", children: breadcrumbs.length > 0 ? breadcrumbs.map((b, idx) => {
      const first = idx === 0;
      ...
      if (!last) {
        return /* @__PURE__ */ jsxs(React8.Fragment, { children: [
          ...
          ) : /* @__PURE__ */ jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__first", children: b.label }),
    ...
    }) : /* @__PURE__ */ jsxs("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__first", children: [
      " ",
      "Home",
      " "
    ] }) }),
...
var IHMenu = memo(function IHMenu2(props) {
  ...
  if (!menu) return null;
  return /* @__PURE__ */ jsx("ih-menu", { children: (() => {
    ...
    return /* @__PURE__ */ jsxs(
      "li",
      {
        ...
        children: [
          isModule ? /* @__PURE__ */ jsx("small", { children: /* @__PURE__ */ jsx(Highlighted, { text: menu.menuName, term: filter }) }) : isType3 ? hasChild ? (
            // group with children
            /* @__PURE__ */ jsxs("div", { onClick: clickGroup, children: [
          ...
          hasChild ? /* @__PURE__ */ jsx(
            "ul",
            {
              className: +menu.menuTypeId === 3 ? menu.visibility ?? "" : "",
              children: (menu.child ?? []).map((m) => /* @__PURE__ */ jsx(
                IHMenu2,
                {
                  menu: m,
                  filter,
...
function IHSidebar(props) {
  ...
  return /* @__PURE__ */ jsxs("ih-sidebar", { children: [
    ...
    !visible ? /* @__PURE__ */ jsx("style", { children: `ih-sidebar { display: none; }` }) : null
  ] });
}
...
export { DEFAULT_ERROR_FACTORIES, IAlert, IButton, ICard, ICardBody, ICardFooter, ICardImage, ICodeViewer, IConfirm, IDatepicker, IDialog, IDialogClose, IDialogOutlet, IDialogProvider, IDialogRef, IFCDatepicker, IFCInput, IFCSelect, IFCTextarea, IGrid, IGridColumn, IGridColumnGroup, IGridCustomColumn, IGridDataSource, IGridExpandableRow, IHContent, IHMenu, IHSidebar, IIcon, IInput, IInputAddon, ILoading, IPaginator, ISection, ISectionBody, ISectionFilter, ISectionFooter, ISectionHeader, ISectionSubHeader, ISectionTab, ISectionTabContent, ISectionTabHeader, ISectionTabs, ISelect, ITextarea, I_ICON_NAMES, I_ICON_SIZES, asMinMaxLengthError, hasNumber, interpolate, isControlRequired, isRecord, readNumber, resolveControlErrorMessage, useDialogData, useDialogRef, useIAlertService, useIConfirmService, useIDialog, useInputMask };
