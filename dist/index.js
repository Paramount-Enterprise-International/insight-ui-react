  ...
  return /* @__PURE__ */ jsxs(
    "i-select",
    {
      ...
      children: [
        ...
        hasOptionsList ? /* @__PURE__ */ jsx("div", { className: `i-options scroll scroll-y ${panelPositionClass2}`, children: filteredOptions.map((row, idx) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: [
              "i-option",
...
function IDatepicker(props) {
  ...
  const onYearChange = useCallback((change) => {
...
function IToggle(props) {
  ...
  const handleHostClick = useCallback(
    (e) => {
      ...
      if (target && (isInteractive(target) || target.closest('a,button,input,textarea,select,[role="button"]')))
        return;
