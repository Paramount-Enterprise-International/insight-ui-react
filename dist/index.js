...
import React8, { useRef, useMemo, forwardRef, useState, useEffect, useCallback, useImperativeHandle, useLayoutEffect, createContext, memo, Children, useContext, Suspense, useSyncExternalStore, lazy } from 'react';
...
var UserMenuService = class {
  ...
  async getEffectiveMenus(applicationId) {
    const response = await this.api.get("/me/menus", {
      apiUrl: this.baseUrl,
      params: applicationId ? { applicationId } : void 0
    });
