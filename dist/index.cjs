...
function IIcon(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("i-icon", { className, size, ...rest, children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: innerClass }) });
}
function ILoading(props) {
  const { label = "Loading..", light = false, className, ...rest } = props;
  return /* @__PURE__ */ jsxRuntime.jsxs("i-loading", { className, light: light ? "" : void 0, ...rest, children: [
...
function isDev() {
  var _a;
  try {
    return ((_a = undefined) == null ? void 0 : _a.DEV) === true;
  } catch {
...
function ICard(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("i-card", { ...hostProps, children: /* @__PURE__ */ jsxRuntime.jsx(
    "a",
    {
      className: "i-card",
      role: "link",
...
function ICodeViewer(props) {
  ...
  const [rawCode, setRawCode] = React8.useState(() => (code ?? "").toString());
  React8.useEffect(() => {
...
var IInput = React8__default.default.forwardRef(
  function IInput2(props, forwardedRef) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("i-input", { className, onClick: handleHostClick, children: [
      prepends.map((a, idx) => /* @__PURE__ */ jsxRuntime.jsx(IInputAddon, { addon: a }, `pre-${idx}`)),
      /* @__PURE__ */ jsxRuntime.jsx(
        "input",
        {
          ref: setRefs,
      ...
      appends.map((a, idx) => /* @__PURE__ */ jsxRuntime.jsx(IInputAddon, { addon: a }, `app-${idx}`))
    ] });
  }
);
function IFCInput(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("i-fc-input", { ...hostProps, children: [
    label ? /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "i-fc-input__label", children: [
      label,
      " :"
    ] }) : null,
    /* @__PURE__ */ jsxRuntime.jsx(
...
var ISelect = React8.forwardRef(function ISelectInner(props, ref) {
  ...
  const optionsListRef = React8.useRef(null);
  const [rawOptions, setRawOptions] = React8.useState(() => options ?? []);
  const [isOpen, setIsOpen] = React8.useState(false);
  const [highlightIndex, setHighlightIndex] = React8.useState(-1);
  const [modelValue, setModelValue] = React8.useState(value ?? null);
  const [pendingModelValue, setPendingModelValue] = React8.useState(null);
  const [displayText, setDisplayText] = React8.useState("");
  const [filterText, setFilterText] = React8.useState("");
  const [typingLoading, setTypingLoading] = React8.useState(false);
  const isLoading = !!loading || typingLoading;
  const displayWithExplicit = React8.useMemo(
  ...
  const debounceTimerRef = React8.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "i-select",
    {
      ...
      children: [
        ...
        hasOptionsList ? /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            className: [
              "i-options",
            ...
            children: filteredOptions.map((row, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  ...
                  children: [
                    renderOption ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "i-option-label", children: renderOption(row) }) : /* @__PURE__ */ jsxRuntime.jsx(
                      "div",
                      {
                    ...
                    isSelected ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "i-option-check", children: /* @__PURE__ */ jsxRuntime.jsx(IIcon, { icon: "check" }) }) : null
                  ]
                },
...
function IFCSelect(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("i-fc-select", { ...hostProps, children: [
    label ? /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "i-fc-select__label", children: [
      label,
      " :",
      " ",
    ...
    invalid && resolvedErrorText ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "i-fc-select__error", children: resolvedErrorText }) : null
  ] });
}
...
function IDatepicker(props) {
  ...
  const today = React8.useMemo(() => startOfDay(/* @__PURE__ */ new Date()), []);
  const [viewYear, setViewYear] = React8.useState(
    () => value ? value.getFullYear() : today.getFullYear()
  );
  const [viewMonth, setViewMonth] = React8.useState(
  ...
  const ensureYearRange = React8.useCallback((focusYear) => {
    setYears((prev) => {
  ...
  const updateViewFromDate = React8.useCallback(
    (d) => {
  ...
  const mask = React8.useMemo(() => ({ type: "date", format }), [format]);
  const focusInput = React8.useCallback(() => {
    var _a;
    (_a = inputElRef.current) == null ? void 0 : _a.focus();
  }, []);
  ...
  const handleTypedInput = React8.useCallback(
    (raw) => {
      setDisplayText(raw);
...
function IFCDatepicker(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("i-fc-datepicker", { ...hostProps, children: [
    label ? /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "i-fc-datepicker__label", children: [
      label,
      " :",
      " ",
...
function ITextarea(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("i-textarea", { children: /* @__PURE__ */ jsxRuntime.jsx(
    "textarea",
    {
      ...rest,
      "aria-invalid": invalid ? "true" : void 0,
...
function IDialog(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("i-dialog", { ...rest, children: [
    ...
    hasAnyActions ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "i-dialog-actions", children: [
      customActions.filter(isVisible).map((a, idx) => /* @__PURE__ */ jsxRuntime.jsx(
        IButton,
        {
          icon: a.icon,
      ...
      (isVisible(okAction) || isVisible(confirmAction) || isVisible(saveAction) || isVisible(cancelAction)) && customActions.filter(isVisible).length > 0 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "flex-fill" }) : null,
      isVisible(okAction) ? /* @__PURE__ */ jsxRuntime.jsx(
        IButton,
        {
          icon: "check",
          variant: "primary",
      ...
      isVisible(confirmAction) ? /* @__PURE__ */ jsxRuntime.jsx(
        IButton,
        {
          icon: "save",
          variant: "primary",
      ...
      isVisible(saveAction) ? /* @__PURE__ */ jsxRuntime.jsx(
        IButton,
        {
          icon: "save",
          variant: "primary",
      ...
      isVisible(cancelAction) ? /* @__PURE__ */ jsxRuntime.jsx(
        IButton,
        {
          icon: "cancel",
          variant: "danger",
...
function IHContent(props) {
  ...
  const matches = reactRouterDom.useMatches();
  const breadcrumbs = React8.useMemo(
    () => buildBreadcrumbsFromMatches(matches),
    [matches]
  );
  const pageTitle = breadcrumbs.length ? breadcrumbs[breadcrumbs.length - 1].label : "Insight";
  const [sidebarVisibility, setSidebarVisibility] = React8.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("ih-content", { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "ih-content-header", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("h1", { children: pageTitle || "Insight" })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "ih-content-breadcrumbs", children: breadcrumbs.length > 0 ? breadcrumbs.map((b, idx) => {
      const first = idx === 0;
      ...
      if (!last) {
        return /* @__PURE__ */ jsxRuntime.jsxs(React8__default.default.Fragment, { children: [
          ...
          ) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__first", children: b.label }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__separator", children: ">" })
        ] }, b.url);
      }
      return /* @__PURE__ */ jsxRuntime.jsx(
        "span",
    ...
    }) : /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__first", children: [
      " ",
      "Home",
      " "
    ] }) }),
...
var IHMenu = React8.memo(function IHMenu2(props) {
  ...
  if (!menu) return null;
  return /* @__PURE__ */ jsxRuntime.jsx("ih-menu", { children: (() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "li",
      {
        ...
        children: [
          isModule ? /* @__PURE__ */ jsxRuntime.jsx("small", { children: /* @__PURE__ */ jsxRuntime.jsx(Highlighted, { text: menu.menuName, term: filter }) }) : isType3 ? hasChild ? (
            // group with children
            /* @__PURE__ */ jsxRuntime.jsxs("div", { onClick: clickGroup, children: [
          ...
          hasChild ? /* @__PURE__ */ jsxRuntime.jsx(
            "ul",
            {
              ...
              children: (menu.child ?? []).map((m) => /* @__PURE__ */ jsxRuntime.jsx(
                IHMenu2,
                {
                  menu: m,
                  filter,
...
function IHSidebar(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("ih-sidebar", { children: [
    ...
    !visible ? /* @__PURE__ */ jsxRuntime.jsx("style", { children: `ih-sidebar { display: none; }` }) : null
  ] });
}
...
function isElementOfType(el, comp) {
  return React8__default.default.isValidElement(el) && el.type === comp;
}
function resolveTab(tabEl, index) {
  ...
  const defaultHeader = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
  ...
  const defaultContent = /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.children });
  let headerNode = props.header ?? defaultHeader;
  let contentNode = props.content ?? defaultContent;
  if (props.children) {
    const childrenArr = React8__default.default.Children.toArray(props.children);
...
function ISectionTabs(props) {
  ...
  const tabs = React8.useMemo(() => {
    const arr = React8__default.default.Children.toArray(children).filter(
  ...
  const initialIndex = React8.useMemo(() => {
  ...
  const [uncontrolledIndex, setUncontrolledIndex] = React8.useState(initialIndex);
  React8.useEffect(() => {
    if (isControlled) return;
  ...
  const activate = React8.useCallback(
    (idx) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("i-section-tabs", { ...rest, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "i-section-tabs-headers", role: "tablist", children: tabs.map((tab, idx) => {
...
exports.ISectionTabContent = ISectionTabContent;
exports.ISectionTabHeader = ISectionTabHeader;
