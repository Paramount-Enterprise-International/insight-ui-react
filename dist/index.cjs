...
function IHContent(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("ih-content", { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "ih-content-breadcrumbs", children: crumbs.length > 0 ? crumbs.map((b, idx) => {
      const first = idx === 0;
      const last = idx === crumbs.length - 1;
      if (!last) {
        return /* @__PURE__ */ jsxRuntime.jsxs(React8__default.default.Fragment, { children: [
          !first ? b.url ? /* @__PURE__ */ jsxRuntime.jsx(
            "a",
            {
          ...
          ) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__link", children: b.label }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ih-content-breadcrumb ih-content-breadcrumb__first", children: b.label }),
