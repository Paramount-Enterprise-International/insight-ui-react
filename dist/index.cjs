...
function IIcon(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("i-icon", { className, ...rest, children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: iconClass }) });
}
    ...
    "i-options",
    {
      ...
      children: filteredOptions.map((row, idx) => /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "i-option-label", children: renderOption ? renderOption(row) : highlightParts(resolveDisplayText(row), effectiveFilterText) }),
